...
/*  private int start;
  ...
  public static boolean entityComparisonNotype(Entity e1, Entity e2)
  {
    //if (e1.getType().equals(e2.getType())
   	 //&& e1.getString().toLowerCase().equals(e2.getString().toLowerCase())
   	//)
    if (e1.getString().toLowerCase().equals(e2.getString().toLowerCase()))
   	{
      for (Location l1 : e1.getLocations())
  	  {
    	boolean match = false ;
  ...
  public static boolean entityComparisonOverlapNotype(Entity e1, Entity e2)
  {
  //	if (e1.getType().equals(e2.getType())
   	// && (entityComparisonSpanOverlap(e1, e2))
   	//)
